              ...
              <div className="w-full md:w-4/12 px-4">
                <div className="text-sm text-blueGray-800 font-semibold py-1 text-center md:text-left">
                  ...
                  <a
                      ...
                      className="text-blueGray-800 hover:text-blueGray-600 text-sm font-semibold py-1"
                  >
                    Creative Tim
                  </a>
                </div>
              ...
              <div className="w-full md:w-8/12 px-4">
                <ul className="flex flex-wrap list-none md:justify-end  justify-center">
                  <li>
                    <a
                        href="https://www.creative-tim.com?ref=nr-footer-small"
                        className="text-blueGray-800 hover:text-blueGray-800 text-sm font-semibold block py-1 px-3"
                    >
                      Creative Tim
                    </a>
                  </li>
